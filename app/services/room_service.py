...
class RoomService:
    ...
    def ready_match(self, match_id: str, player_id: str) -> None:
        state = self.repo.get_match(match_id)
        if not state:
            raise ValueError("match not found")
